...
class DrawInformation:
    ...
    def set_list(self, lst):
        ...
        self.block_height = math.floor(
            (self.height - self.TOP_PAD) / (self.max_val - self.min_val))  # / range of numbers
        self.start_x = self.SIDE_PAD // 2  # starting point of block
...
def draw_list(draw_info, color_positions={}, clear_bg=False):
    ...
    # enumerate : gonna index and value of every element in list
